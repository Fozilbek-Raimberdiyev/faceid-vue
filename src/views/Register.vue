<template>
    <div class="h-full flex flex-col items-center justify-center gap-6 w-full max-w-[720px] mx-auto">
      ...
      <div class="w-full p-4 text-right">
        <div class="mx-auto w-full max-w-md">
          ...
          <div v-if="!customUser" class="flex flex-col items-center justify-center w-full mt-3">
            <label
              for="dropzone-file"
